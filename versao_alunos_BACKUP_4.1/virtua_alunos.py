...
EXE_FILE_ID      = "1l1IUDjZ-Qx0dEb2YTRlb7rAqjKHSUyeB"
...
def verificar_atualizacao():
    ...
    try:
        ...
        url = f"https://docs.google.com/document/d/{VERSION_FILE_ID}/export?format=txt"
        r = requests.get(url)
...
def aplicar_update():
    ...
    exe_novo = os.path.join(pasta, "Virtua_update.exe")

    url = f"https://drive.google.com/uc?export=download&id={EXE_FILE_ID}"
